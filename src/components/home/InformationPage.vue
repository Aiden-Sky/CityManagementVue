      ...
      <div class="col-md-3">
        <div class="sidebar">
          <div class="btn-container">
            <button class="btn btn-success mb-3" @click="addReport(newReport)">新增</button>
            <button class="btn btn-danger mb-3" @click="deleteSelectedReports">批量删除</button>
          </div>
          <h5>查询</h5>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-primary" @click="saveReport">保存</button>
...
export default {
  ...
  methods: {
    fetchReports(page = 1) {
      ...
      axios.get(`http://localhost:8081/city/caseInfom/getInfoms?page=${page}&pageSize=${pageSize}`, {
        headers: {
          'Authorization': token
        }
      })
